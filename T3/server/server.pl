...
parse_input(get_move(B,PiecesP1, PiecesP2, Player,TypePlayer,Level),[0]).

parse_input(game_over(PiecesP1,PiecesP2),Winner):-
    game_over(board(_,PiecesP1,PiecesP2), Winner).
