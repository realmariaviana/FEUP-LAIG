    ...
    if(initialView == "view1"){
      ...
      if(this.scene.graph.file_name == "sala.xml"){
        ...
        if(this.scene.graph.file_name == "sala.xml"){
          ...
          this.initialPosition= [6,15,8];
          this.initialTarget=[5,0,1];
        }
      }
    ...
    if(finalView == "view1"){
      ...
      if(this.scene.graph.file_name == "sala.xml"){
        ...
        if(this.scene.graph.file_name == "sala.xml"){
          ...
          this.finalPosition=[6,15,8];
          this.finalTarget=[6,-30,1];
        }
      }
